...
def main():
    ...
    data = {'lat': [52.548397087668235, 52.40988381501502, 52.520008, 52.62619574073854], 'lon': [5.225299845087256, 4.941418050084637, 13.404954, 5.022999973718499],
            'name': ['Midden_ijselmeer', 'Amsterdam', 'Berlijn', 'Hoorn_505meter']}
